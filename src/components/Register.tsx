...
const Register: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex">
      {/* Left Column - Form */}
      <div className="w-full lg:w-[45%] flex flex-col justify-center px-8 sm:px-16 lg:px-24 overflow-y-auto pt-10 pb-16 h-screen">
        {/* Logo */}
        ...
        <div className="animate-slide-up">
          ...
          <p className="text-sm text-gray-600 font-medium mb-8">
            ...
            <Link to="/login" className="text-auth-purple hover:text-auth-blue transition-colors underline decoration-2 underline-offset-4 font-bold">
              Log in here
            </Link>
          </p>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="firstName" className="block text-sm font-bold text-gray-900 mb-1.5">
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 bg-white border ${errors.firstName ? 'border-red-500' : 'border-gray-300'} rounded-xl focus:ring-2 focus:ring-auth-purple focus:border-transparent outline-none transition-all`}
              ...
              <div>
                <label htmlFor="lastName" className="block text-sm font-bold text-gray-900 mb-1.5">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 bg-white border ${errors.lastName ? 'border-red-500' : 'border-gray-300'} rounded-xl focus:ring-2 focus:ring-auth-purple focus:border-transparent outline-none transition-all`}
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-3 bg-white border ${errors.email ? 'border-red-500' : 'border-gray-300'} rounded-xl focus:ring-2 focus:ring-auth-purple focus:border-transparent outline-none transition-all`}
            ...
            <div>
              <label htmlFor="userType" className="block text-sm font-bold text-gray-900 mb-1.5">
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-auth-purple focus:border-transparent outline-none transition-all appearance-none cursor-pointer"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 bg-white border ${errors.password ? 'border-red-500' : 'border-gray-300'} rounded-xl focus:ring-2 focus:ring-auth-purple focus:border-transparent outline-none transition-all pr-10`}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 bg-white border ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'} rounded-xl focus:ring-2 focus:ring-auth-purple focus:border-transparent outline-none transition-all pr-10`}
            ...
            <div className="flex items-start mt-2">
              <input
                ...
                type="checkbox"
                required
                className="mt-1 h-4 w-4 text-auth-purple focus:ring-auth-purple border-gray-300 rounded cursor-pointer"
              />
              <label htmlFor="terms" className="ml-2 block text-xs text-gray-600">
                I agree to the <Link to="/terms" className="text-auth-purple hover:underline font-semibold">Terms of Service</Link> and <Link to="/privacy" className="text-auth-purple hover:underline font-semibold">Privacy Policy</Link>
              </label>
            </div>
